...
SIGNATURE_IMAGE_PATH = "static/assinatura.jpg"
...
class PDF(FPDF):
    ...
    def add_signature(self):
        self.set_y(-70)
        self.image(SIGNATURE_IMAGE_PATH, x=70, w=70)
...
def generate_pdf():
    try:
        ...
        pdf_filename = f"orcamento_{client_name.replace(' ', '_').lower()}_{datetime.now().strftime('%Y%m%d')}.pdf"
